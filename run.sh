...
# Lorenz63
python3 generate_lorenz.py --folder "data" --name "L63" --n_samples 5000 --burn_in 100 --discard_interval 20
# Lorenz96
python3 generate_lorenz.py --folder "data" --name "L96" --n_samples 5000 --burn_in 100 --discard_interval 20
...
python3 main.py --data_name "L63" --init_dist "Cauchy" --init_loc 0 --init_scale 1 --init_rho 0.3
python3 main.py --data_name "L96" --component 1 --init_dist "Cauchy" --init_loc 0 --init_scale 1 --init_rho 0.3
